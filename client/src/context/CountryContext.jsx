...
import { createCountriesRequest, getCountriesRequest} from '../api/country';
...
/*     const [country, setCountry] = useState([]);
    ...
    const createCountry = async(country) => {
        const res = await createCountriesRequest(country);
        setCountry(prevCountries => [...prevCountries, res.data])
    }
 */
